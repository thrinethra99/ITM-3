				...
				success : function(data) {
					...
					var shape = "shape"+""+t_id;
					 ...
					 var trace = {
								...
								y : [ y11+2.5 ],
								text : ["<a href='thread.jsp?threadid='"+title_thread_id[0]+"'&threadname='"+title_threadfocus[0]+"''><b>"+title_threadfocus[0]+"</b></a>"+" => <b>"+title_thread_id.length+" note(s) by "+uniqueAuthors.length+" author(s).</b>"],
								textposition: "right",
								hoverinfo: "none",
								textfont : {
									family : 'sans serif',
