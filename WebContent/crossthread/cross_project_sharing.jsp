	...
	$(document).ready(function() {
								...
								$.ajax({
									...
									success : function(data, textStatus, jqXHR) {
										if(data.code=="success"){
											  if($.trim(data.desc)!=$.trim("No data aviliable.")){
												  ...
												  for(var i in json){	
													  if(typeof(threadid[json[i].thread_id])=="undefined"){
														  ...
														  var jot_html ="	<div id='jot_details_"+json[i].thread_id+projectId+"' style=\"border-bottom: 1px solid\">"
														  ...
														  threadid[json[i].thread_id]=1
														  last_thread='jot_details_'+json[i].thread_id+projectId
													  }
												 ...
												 var jot_html =
														"	<div id='jot_details_"+json[i].thread_id+projectId+"' style=\"\">"
														+"No data"
														+"	</div>"
											  ...
											  $("#"+last_thread).css("border-bottom","0px");
							...
							function enterProject(ProjectId,crossdb,cid,cname){
								if(cid=="<%=session.getAttribute("community_id")%>"){
						        	...
						        	window.location.href = "../project/cross/dashboard.jsp?projectid="+ProjectId+"&crossdb="+crossdb+"&community_id="+cid+"&community_name="+cname;
