...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
							...
							<table>
								<thead>
									<tr>
										<th>Cross-project
									Sharing Space</th>
										<th><a class="btn" style="height:20px;line-height:20px; cursor: pointer;" id="cross_project_sharing">
										Enter</a></th>
									</tr>
								</thead>
	...
	<div class="container">
		...
		<i class='material-icons' id='deleted_ideathread_list' style='cursor: pointer'>delete</i>
	</div>
	
	
	</main>
	
	 <div id="deleted_ideathread_list_modal" class="modal modal-fixed-footer">
		  <div class="modal-content">
		     <p id="deleted_ideathread_list_content"></p>
		  </div>
	...
	$(document).ready(function() {
		$("#cross_project_sharing").click(function(){
	    	window.location.href="../../thread/cross_project_sharing.jsp?localdb="+localdb+"&token="+token+"&community="+community+"&c_id="+c_id+"&type="+type+"&urname="+urname+"&id="+id+"&itmdb="+itmdb+"&domain="+domain+"&school="+school+"&country="+country+"&city="+city+"&projectid="+project_id; 
	     });
	})
				...
				if(tbox_checked_str.lenght!=""){
					$.ajax({
			            ...
			            success: function (response) {
			            	window.open("../../thread/mapping.jsp?localdb="+localdb+"&token="+token+"&community="+community+"&c_id="+c_id+"&type="+type+"&urname="+urname+"&id="+id+"&itmdb="+itmdb+"&domain="+domain+"&school="+school+"&country="+country+"&city="+city+"&projectid="+project_id);
			            }
			        });	
				}
				else{
	...
	function callAjaxfunc(callback){
					...
					if (d.children ) {
					    ...
					    if(threadname.length>0){
						    if(threadname.indexOf(d.name) !== -1){
								 ...
								 window.open("../../thread/thread.jsp?localdb="+localdb+"&token="+token+"&community="+community+"&c_id="+c_id+"&type="+type+"&urname="+urname+"&id="+id+"&itmdb="+itmdb+"&domain="+domain+"&school="+school+"&country="+country+"&city="+city+"&projectid="+project_id+"&threadid="+tid+"&threadname="+tname);
							}
						}
					} 
					  else {
		...
		$(document).ready(function() {
							...
							$("#deleted_ideathread_list").click(function(){
								...
								var jsonData = {
									...
									$.ajax({
										...
										success : function(data, textStatus, jqXHR) {
											...
											if(data.code=="success"){
												var html =""
												$("#deleted_ideathread_list_modal").modal('open');
												$("#deleted_ideathread_list_content").empty().html("");
								...
								$("#deleted_ideathread_list_content").html("abcdef<button class='btn'>Testing</button>");
							});
			...
			$("#btn-add-teacher-reminder").click(function(){
				...
				$("#add_reminder").modal('open');
								...
								function initTeacherReminder(){
									...
									$("#page_title").html('<a href="../../dashboard.jsp"><%=session.getAttribute("community")%></a>-><a href="../openedit.jsp">'+project.title+'  Dashboard</a>')
									$('select').material_select();
									function init(){
										initProjectGoal()
										initTeacherReminder()
