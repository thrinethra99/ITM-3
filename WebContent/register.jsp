  ...
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
    ...
    <div class="row">
        <div class="input-field col s12">
          ...
          <label for="email">Gmail [ create a user profile using your google account.  ]</label> 
        </div>
      </div>
       <div class="row">
        <div class="input-field col s12">
        <a  id="register" class="waves-effect waves-light btn">Register</a>
        <a href="/ITM3" class="waves-effect waves-light btn">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script type="text/javascript">
    $("#register").click(function () {
        ...
        if(username==""||pwd==""||email==""){
            $.notify('username,password,email is required ', 'warn');
               ...
               $.ajax({
                url :  "//IIUS/util/getToken?uid="+uid,
                type : "Get",
    ...
    function  register(jsondata){
              ...
              $.ajax({
                ...
                dataType : "json",
                success : function(data, textStatus, jqXHR) {
                    Materialize.toast('Welcome '+jsondata["username"]+", Please login in", 4000)
                    setTimeout(function() {
